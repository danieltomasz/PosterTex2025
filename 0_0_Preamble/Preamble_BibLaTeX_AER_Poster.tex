...
\usepackage[backend=biber, natbib=true, bibstyle=authoryear, citestyle=numeric, mincitenames=1, maxcitenames=2, minbibnames=1, maxbibnames=7, uniquename=false, uniquelist=true, giveninits=true, backref=false, doi=false, eprint=false, url=false, isbn=false, dashed=false, sorting=ynt, sortcites=true, mergedate=true, dateabbrev=false, abbreviate=false, citetracker=true]{biblatex}
